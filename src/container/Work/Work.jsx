...
import about0q from '../../assets/about01.png';
...
const works = [
  ...
  },
  {
    ...
    description: 'Building a project with React JS for interactive web interfaces.',
    imgUrl: about0q,
    projectLink: 'https://example.com',
    codeLink: 'https://github.com/example',
    tags: ['React JS'],
...
const Work = () => {
  ...
  return (
    <>
      <h2 className="head-text">My Innovative <span>Projects</span></h2>
